...
//    OrderBO orderBO=BOFactory.getInstance().getBO(BOType.ORDER);
    ...
    CustomerBO customerBO= AppInitializer.getApplicationContext().getBean(CustomerBO.class);
    ItemBO itemBO=AppInitializer.getApplicationContext().getBean(ItemBO.class);
    OrderBO orderBO=AppInitializer.getApplicationContext().getBean(OrderBO.class);
